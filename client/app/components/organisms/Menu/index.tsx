                ...
                <div className="flex">
                    ...
                    <ul className="flex ml-10">
                        <li className="relative">
                            <a className="text-sm text-blue-600 font-bold" href="#">For customers</a>
                            <div className="absolute left-0 z-20 w-48 py-2 mt-2 origin-top-right bg-white rounded-md shadow-xl">
