            ...
            <nav className="relative px-8 py-4 flex justify-between items-center bg-white">
                <div className="flex">
                    ...
                    <ul className="flex ml-10">
                        <MenuItem title="For creators" />
                        <MenuItem title="For developers" />
                    </ul>
                </div>
                <a
                ...
                <a
                    className="hidden lg:inline-block py-2 px-6 bg-black text-sm text-white font-bold rounded-xl transition duration-400 hover:bg-gray-700 "
                    href="#"
                >
                    Hire developers
                </a>
