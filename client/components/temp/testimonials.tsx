const Testimonials = () => {
    return (
        <section className="relative flex my-20">
            <div className="min-h-screen bg-white md:w-3/4"></div>
            <div className="min-h-screen bg-gradient-to-l from-[#e4f2fe] to-[#ffeefe] md:w-2/5"></div>

            <div className="flex flex-col justify-center w-full min-h-screen px-4 py-10 md:absolute md:mx-24 left-0 top-0 ">
                ...
                <div className="grid w-full grid-cols-1 gap-8 mt-8 2xl:grid-cols-4 lg:mt-16 md:grid-cols-2 lg:grid-cols-3">
                    <div className="w-full p-8 bg-white rounded-md shadow-lg ">
                        <p className="leading-loose text-gray-500 ">
                            ...
                            elit. Sit ea tempora dolores qui eius pariatur odit
                            ad voluptas iste, cum accusantium beatae tempore
                            quasi nesciunt distinctio. ”
                        </p>
                    ...
                    <div className="w-full p-8 bg-white rounded-md shadow-lg  md:hidden lg:block">
                        <p className="leading-loose text-gray-500 ">
                            “ Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Sit ea tempora dolores qui eius pariatur odit
                            ad voluptas iste, cum accusantium beatae tempore
                    ...
                    <div className="w-full p-8 bg-white rounded-md shadow-lg  md:hidden 2xl:block">
                        <p className="leading-loose text-gray-500 ">
                            “ Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Sit ea tempora dolores qui eius pariatur odit
                            ad voluptas iste, cum accusantium beatae tempore
